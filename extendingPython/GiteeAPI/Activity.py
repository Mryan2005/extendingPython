...
if __name__ == '__main__':
    owner = "university-work"
    repo = "python-big-work"
    page = 1
    access_token = "36d7fb84455fa8bcf8af2ac7aec227b0"
    per_page = 100
    print(getTheUserWhoStarTheRepo(owner, repo, page, access_token, per_page))
    owner = "university-work"
    repo = "sy5"
    page = 1
    access_token = "36d7fb84455fa8bcf8af2ac7aec227b0"
    per_page = 100
    print(getTheUserWhoWatchTheRepo(owner, repo, page, per_page=per_page))
    owner = "university-work"
    repo = "sy5"
    access_token = "36d7fb84455fa8bcf8af2ac7aec227b0"
    limit = 100
    prev_id = -1
    print("The message from the repo:")
    print(getTheMassageFromTheRepo(owner, repo))
